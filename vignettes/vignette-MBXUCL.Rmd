...
cvOPLSDA.res = cvOPLSDA(x = x, y = y, k_fold = 10, NumOrtho = 3)
...
predictedval = OPLSDA_pred(ropls = oplsda.res, x.new = xnew)
pander(data.frame(trueval,predictedval))
